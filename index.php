						...
						<div class="row gtr-200">
							...
							<div class="col-9 col-12-medium imp-medium">
								...
								<!-- Content -->
									<div id="content">
										<section class="last">
											<h2>¿Buscas un Diseño Personalizado?</h2>
											<img src="img/Mocup..jpg" alt="" >
											<p><strong>Biktion</strong>, diseñara la prenda segun sus gustos y preferencias Contácta el equipo de Diseño.
											<a href="https://www.facebook.com/frankyymari07" target="_blank" class="icon fa fa-facebook fa-lg "></i></a>
										</section>
									</div>
							</div>
						</div>
